<template>
  <span
    class="text-sm dark:bg-[#121212] dark:text-white text-gray-500 sm:text-center flex justify-center items-center"
    >Made by
    <a
      href="https://www.youtube.com/channel/UCAARceUUB_X6xsgeRBRg16A"
      class="ml-1 hover:underline"
      >Alexander Gekov</a
    >
    <a href="https://twitter.com/AlexanderGekov">
      <svg
    ...
    <a href="https://www.facebook.com/alexander.gekov00">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
    ...
    <a href="https://www.linkedin.com/in/aleksandar-gekov/">
      <svg
        xmlns="http://www.w3.org/2000/svg"
        width="16"
        height="16"
