<template>
    ...
    >
      <div
        class="flex items-start justify-center min-h-screen mt-10 text-center"
      >
        <div
          ...
          aria-modal="true"
        >
            <button @click="$emit('close')" type="button" class="absolute top-0 right-0 m-2 text-slate-700 dark:text-slate-600 dark:hover:text-slate-400 bg-transparent hover:text-gray-900 rounded-lg text-sm p-1.5 ml-auto inline-flex items-center" data-modal-hide="staticModal">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>  
            </button>
            <div class="max-w-3xl mx-auto">
              <h1 class="text-3xl font-bold mb-4">Кой го казва?</h1>
              <p class="mb-4">Общообразователно игра, в която трябва да се опитате да познаете, чий е цитатът на екрана.</p>
              ...
              <p>Играта засега наброява 3000+ цитата от 48то Народно събрание. (С изключение на Бойко Борисов, чиито цитати са от периода 2017-2020, когато е бил министър-председател.)</p>
            </div>
            <hr class="my-4">
            ...
            <div class="flex flex-col justify-center items-center">
              ...
              <div class="flex items-center">
                <input type="text" class="border dark:bg-[#1f1e1e] border-gray-400 rounded-md py-2 px-4 mr-2" v-model="username" :disabled="!isUsernameEditable">
                <button class="relative dark:text-slate-700 text-blue-500" @click="toggleEditStatus('username',!isUsernameEditable)">
            ...
            <div class="flex flex-col justify-center items-center">
              ...
              <div class="flex items-center">
                <select class="border dark:bg-[#1f1e1e] border-gray-400 rounded-md py-2 px-4 mr-2" v-model="gameMode">
...
const username = useStorage('username', 'Непознат играч №' + Math.floor(Math.random() * 1000).toString().padStart(3, '0'))
